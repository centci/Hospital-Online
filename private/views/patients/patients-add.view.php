    ...
    <div class="row">
      <div class="col-sm-2 my-1">
        <div class="input-group">
          <select class="form-select <?= isset($errors['title']) ? 'border-danger' : ''; ?>" name="title">
            <option <?=esc(get_select('title', ''))?> value="">Title</option>
      ...
      <div class="col-sm-4 my-1">
        <div class="input-group">
          ...
          <input type="text" class="form-control <?= isset($errors['firstname']) ? 'border-danger' : ''; ?>" name="firstname" value="<?= esc(set_value('firstname')); ?>" placeholder="First Name">
        </div>
        <small class="text-danger">
      ...
      <div class="col-sm-3 my-1">
        <div class="input-group">
          ...
          <input type="text" class="form-control <?= isset($errors['middlename']) ? 'border-danger' : ''; ?>" name="middlename" value="<?= esc(set_value('middlename')); ?>" placeholder="Middle Name">
        </div>
        <small class="text-danger">
      ...
      <div class="col-sm-3 my-1">
        <div class="input-group">
          ...
          <input type="text" class="form-control <?= isset($errors['lastname']) ? 'border-danger' : ''; ?>" name="lastname" value="<?= esc(set_value('lastname')); ?>" placeholder="Last Name">
        </div>
        <small class="text-danger">
    ...
    <div class="row">
      <div class="col-sm-4 my-1">
        <div class="input-group">
          ...
          <input type="date" class="form-control <?= isset($errors['dob']) ? 'border-danger' : ''; ?>" name="dob" value="<?= esc(set_value('dob')); ?>" placeholder="DOB">
        </div>
        <small class="text-danger">
      ...
      <div class="col-sm-4 my-1">
        ...
        <select name="gender" class="form-select <?= isset($errors['gender']) ? 'border-danger' : ''; ?>">
          <option <?=esc(get_select('gender', ''))?> value="">Gender</option>
      ...
      <div class="col-sm-4 my-1">
        <div class="input-group">
          ...
          <input type="text" class="form-control <?= isset($errors['phone']) ? 'border-danger' : ''; ?>" name="phone" value="<?= esc(set_value('phone')); ?>"  placeholder="Phone">
        </div>
        <small class="text-danger">
      ...
      <div class="col-sm-4 my-1">
        <div class="input-group">
          ...
          <input type="text" class="form-control <?= isset($errors['nok']) ? 'border-danger' : ''; ?>" name="nok" value="<?= esc(set_value('nok')); ?>" placeholder="Next Of Kin">
        </div>
        <small class="text-danger">
      ...
      <div class="col-sm-4 my-1">
        <div class="input-group">
          ...
          <input type="text" class="form-control <?= isset($errors['nokphone']) ? 'border-danger' : ''; ?>" name="nokphone" value="<?= esc(set_value('nokphone')); ?>" placeholder="NOK Phone">
        </div>
        <small class="text-danger">
      ...
      <div class="col-sm-4 my-1">
        ...
        <select name="country" class="form-select <?= isset($errors['country']) ? 'border-danger' : ''; ?>">
          <option <?=esc(get_select('country', ''))?> value="">Country</option>
    ...
    <div class="row">
      <div class="col-sm-3 my-1">
        <div class="input-group">
          ...
          <input type="text" class="form-control <?= isset($errors['district']) ? 'border-danger' : ''; ?>" name="district" value="<?= esc(set_value('district')); ?>" placeholder="District">
        </div>
        <small class="text-danger">
      ...
      <div class="col-sm-3 my-1">
        <div class="input-group">
          ...
          <input type="text" class="form-control <?= isset($errors['county']) ? 'border-danger' : ''; ?>" name="county" value="<?= esc(set_value('county')); ?>" placeholder="County">
        </div>
        <small class="text-danger">
      ...
      <div class="col-sm-3 my-1">
        <div class="input-group">
          ...
          <input type="text" class="form-control <?= isset($errors['subcounty']) ? 'border-danger' : ''; ?>" name="subcounty" value="<?= esc(set_value('subcounty')); ?>" placeholder="Sub-County">
        </div>
        <small class="text-danger">
      ...
      <div class="col-sm-3 my-1">
        <div class="input-group">
          ...
          <input type="text" class="form-control <?= isset($errors['village']) ? 'border-danger' : ''; ?>" name="village" value="<?= esc(set_value('village')); ?>" placeholder="Village">
        </div>
        <small class="text-danger">
