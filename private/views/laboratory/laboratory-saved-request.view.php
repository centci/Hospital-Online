      ...
      <div class="card-body" style="min-height:118px;">
        <div class="row">
          <nav class="navbar navbar-light bg-light mt-2">
            ...
            <h2>Laboratory Saved Requests </h2>
            ...
            <?php if (!empty($rows)): ?>
              ...
              <?php foreach ($rows as $row): ?>
                <tr class="tr-fix">
                  ...
                  <td class="td-fix tb-nowrap text-end"><?=esc($row->DrawnDate) ?></td>
                  <td class="td-fix tb-nowrap text-end">
                    <a href="<?=ROOT?>/Laboratorys/LaboratorysavedrequestDetails_submitReport/<?= strtolower($row->patientId) ?>/<?= strtolower($row->labReqSampleId) ?>" class="btn btn-sm btn-primary"> Report
                    </a>
                  </td>
                </tr>
              <?php endforeach; ?>
