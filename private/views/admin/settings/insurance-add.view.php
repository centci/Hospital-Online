...
<div class="col-lg-12 " style="margin-bottom: 150px;">
  <div class="container-fluid border rounded col-lg-6 mt-5 p-2 shadow-lg">
    ...
    <form class='' method="POST">
      <input class="form-control my-2 <?= isset($errors['insuranceName']) ? 'border-danger' : 'border-primary';?>" type="text" name='insuranceName' value="<?=set_value('insuranceName') ?>" placeholder='Enter Insurances' autofocus>
