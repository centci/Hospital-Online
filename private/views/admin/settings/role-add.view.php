...
<div class="col-lg-12 " style="margin-bottom: 150px;">
  <div class="container-fluid border rounded col-lg-6 mt-5 p-2 shadow-lg">
    ...
    <form class='' method="POST">
      <input class="form-control my-2 <?= isset($errors['role']) ? 'border-danger' : 'border-primary';?>" type="text" name='role' value="<?=set_value('role') ?>" placeholder='Enter Role' autofocus>
