  ...
  <div class="container-fluid border rounded col-lg-6 mt-5 p-2 shadow-lg">
    <div class="container border border-primary rounded p-2">
      <center>
        ...
        <h5 class="text-primary">Employee Specialization</h5>
      </center>
    </div>

    <form class='' action="" method="POST">
      <input class="form-control my-2 <?= isset($errors['specialized']) ? 'border-danger' : 'border-primary';?>" type="text" name='specialized' value="<?=set_value('specialized',$row->specialized) ?>" placeholder='Enter Laboratory' autofocus>
      <div class="text-danger">
        <?php if (isset($errors['specialized'])): ?> <?= $errors['specialized']?> <?php endif; ?>
      </div>
      <a href="<?=ROOT?>/specializations" class='btn btn-primary btn-sm mt-2'><i class="fa fa-chevron-left"></i>Back</a>
