...
<div class="col-lg-12">
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      <h3 class="mb-0">Hospital Departments</h3> <!-- Use `mb-0` to remove default margin -->
        ...
        <tbody>
          <?php if ($data): ?>
            ...
            <tr>
              ...
              <td class="text-end">
                <a href="<?=ROOT?>/departments/edit/<?=$row->id?>" class="text-primary"><i class="fa fa-edit"></i></a>|
                <a href="<?=ROOT?>/departments/delete/<?=$row->id?>" class="text-danger"><i class="fa fa-trash-alt"></i></a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php else: ?>
