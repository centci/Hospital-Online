...
<div class="col-lg-12">
  ...
  <h4 class="breadcrumb-item">Sample Container</h4>
  ...
  <div class="card">
    <div class="card-body">
      ...
      <?php endif; ?><!-- Success message end. -->
        ...
        <a href="<?=ROOT ?>/Containers/add">
          <button class="btn btn-primary my-2 float-end"><i class="fa fa-plus"></i>Add Containers</button>
        </a>
          ...
          <?php if ($data): ?>
            ...
            <tr>
              ...
              <td class="text-end">
                ...
                <a href="<?=ROOT?>/Containers/delete/<?=$row->id?>" class="text-danger"><i class="fa fa-trash-alt"></i></a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php else: ?>
