...
<div class="col-lg-12">
  ...
  <h4 class="breadcrumb-item">Sample Types</h4>
  ...
  <div class="card">
    <div class="card-body">
      ...
      <?php endif; ?><!-- Success message end. -->
        ...
        <a href="<?=ROOT ?>/Samples/add">
          <button class="btn btn-primary my-2 float-end"><i class="fa fa-plus"></i>Add Samples</button>
        </a>
        ...
        <tbody>
          <?php if ($data): ?>
            ...
            <tr>
              ...
              <td class="text-end">
                <a href="<?=ROOT?>/Samples/edit/<?=$row->id?>" class="text-primary"><i class="fa fa-edit"></i></a>|
                <a href="<?=ROOT?>/Samples/delete/<?=$row->id?>" class="text-danger"><i class="fa fa-trash-alt"></i></a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php else: ?>
