  ...
  <div class="card">
    ...
    <table class="table table-hover table-stripped"><!-- start Table -->
      ...
      <tbody class="extra-tests save-test-content">
        <?php if ($testxtra): $num = 0;?>
          <?php foreach ($testxtra as $row):?>
            <tr>
              <td> <input type="text" class="form-control" name="subTestCode_<?=$num?>" value="<?= $row->subTestCode ?>" readonly> </td>
              <td> <input class="form-control" type="text" name="xtraTestName_<?=$num?>" value="<?= $row->xtraTestName ?>" readonly> </td>
              <td> <input type="text" class="form-control" name="xtraRefRanges_<?=$num?>" value="<?= $row->xtraRefRanges ?>" readonly> </td>
              <td> <input class="form-control" type="text" name="unitname_<?=$num?>" value="<?= $row->unitRow->unitname ?>" readonly> </td>
              <td class="text-end ">
                <!-- empty space -->
              </td>
            </tr>
